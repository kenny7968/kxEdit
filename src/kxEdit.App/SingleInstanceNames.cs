...
/// </para>
/// <para>
/// <b>名前はビルドをまたぐ互換性契約である。</b>
/// <see cref="SingleInstanceOutcome.ForeignPeer"/> に落ちる 2 経路のうち
/// <b>実行ファイルパスの不一致の経路</b>(= 別フォルダの別ビルドが起動していることの検出。
/// 設計 §4 ★3)は、新旧ビルドが同じ名前を使うことで成立する。
/// ここの文字列をドリフトさせると新旧ビルドが
